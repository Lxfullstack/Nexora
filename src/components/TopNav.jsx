    ...
    return (
        <nav ref={container} className="navbar bg-white sticky top-0 z-50 shadow-sm">
            <div className="container mx-auto flex items-center justify-between px-4 py-4">
                ...
                <div className="hidden md:flex items-center gap-2 w-72 lg:w-96 border border-neutral-400 px-4 py-1">
                    <input
                        type="text"
                ...
                <button className="hidden md:flex items-center justify-center px-4 py-2 bg-(--color-primary) text-white rounded text-sm">
                    Get Started
                </button>
